    ...
    <div className="flex min-h-screen bg-white font-sans text-ink">
      ...
      <aside className="relative hidden w-[42%] overflow-hidden bg-ink lg:flex">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-32 -top-32 h-[500px] w-[500px] rounded-full bg-deep-violet/60 blur-[120px]" />
          <div className="absolute -bottom-40 right-0 h-[450px] w-[450px] rounded-full bg-magenta/40 blur-[100px]" />
          <div className="absolute bottom-1/3 left-1/3 h-[300px] w-[300px] rounded-full bg-coral/20 blur-[80px]" />
        </div>

        <div className="relative z-10 flex flex-1 flex-col p-10 xl:p-12">
          {/* Logo */}
          <Link href="https://sayvors.com" className="mb-12 inline-flex w-fit items-center gap-2.5 opacity-90">
          ...
          <div className="mb-auto flex justify-center">
            <div className="relative w-full max-w-sm">
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-white/10 to-transparent blur-xl" />
              <Image
      ...
      <main className="relative flex flex-1 items-center justify-center px-6 py-10">
        ...
        <Link
          ...
          className="absolute left-6 top-6 z-10 inline-flex items-center gap-1 text-[13px] font-medium text-ink/30 transition-colors hover:text-ink/60"
        >
